...
const Contact = () => {
  ...
  return (
    <div className="relative min-h-screen bg-gray-50 py-10 px-4 sm:px-6 md:px-8 lg:px-16">
      <Head>
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "ContactPage",
              name: "Contact Us | Yuvabe Studios",
              description:
                "Reach out to Yuvabe Studios for inquiries, collaborations, and feedback.",
              ...
              address: {
                "@type": "PostalAddress",
                streetAddress: "Saracon campus, Kottakarai Road",
