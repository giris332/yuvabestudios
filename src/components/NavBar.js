...
const NavBar = () => {
  ...
  const navLinks = ["/", "/about", "/work", "/career", "/contact"];

  // Disable body scroll when contact form is open
  useEffect(() => {
      ...
      >
        <div className="flex justify-between items-center">
          ...
          <MotionLink href="/" passHref>
            <Image
              src="/images/profile/yb-logo.png"
              alt="Logo"
              width={150}
              height={100}
            />
          ...
          {/* Desktop Navigation */}
          <motion.nav
            className="hidden md:flex space-x-4 bg-gray-200 bg-opacity-20 backdrop-blur-lg px-6 py-2 rounded-lg mx-auto"
            initial="hidden"
            animate="visible"
          ...
          <button
            ...
            className="hidden md:inline-flex px-4 py-2 border bg-yellow-400 border-violet-800 text-violet-800 rounded-lg hover:bg-violet-800 hover:text-white transition"
          >
          ...
          {/* Mobile Menu Toggle */}
          <button
            className="md:hidden text-2xl text-violet-800 ml-auto"
        ...
        {isMobileMenuOpen && (
          <motion.div
            className="md:hidden mr-2 mt-4 flex flex-col items-center space-y-4 bg-gray-100 bg-opacity-90 backdrop-blur-md p-4 rounded-lg absolute right-0 top-16 w-64"
            initial="hidden"
            animate="visible"
            variants={containerVariants}
          >
